...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/92 shadow-sm shadow-slate-200/70 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/90 dark:shadow-black/20">
      ...
      <div className="container mx-auto px-6">
        <div className="flex min-h-[72px] items-center justify-between gap-4">
          ...
          <nav className="hidden items-center gap-1 rounded-lg border border-slate-200 bg-slate-50 p-1 dark:border-slate-800 dark:bg-slate-900 md:flex">
